...
pointVenteRouter.get('/', getAllpointVente); // Route pour obtenir toutes les pointVentes
pointVenteRouter.get("/:id", getAllpointVenteById); // Route pour obtenir une pointVente par ID 
